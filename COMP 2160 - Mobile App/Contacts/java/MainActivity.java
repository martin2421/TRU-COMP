...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(new Contact_modal(R.drawable.img_2, "Ines M.", "+1 (616) 123-2421", "ines@email.com"));
        ...
        arrayList.add(new Contact_modal(R.drawable.img_8, "Martin A.", "+1 (211) 320-6521", "martin@email.com"));
