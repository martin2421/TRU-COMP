 ...
 * Program Description: Using a generic ArrayStack to solve whether a parentheses
 * is balanced or not. Program will push() an open bracket ( i.e. (, [, { ) and 
 * pop() it if it finds its corresponding closing bracket ( i.e. ), ], } ) and 
 * checks if the whole parentheses are balanced or if it has a mismatch bracket.
 ****/
